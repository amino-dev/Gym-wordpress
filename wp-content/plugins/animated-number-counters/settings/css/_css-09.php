...
.anc-6310-counter-09-row {
  background-color: <?php echo isset($cssData['full_background_color']) && $cssData['full_background_color'] !== '' ? $cssData['full_background_color'] : 'rgba(29, 29, 29, 1)'; ?>;
  padding: 80px 10px;
  overflow: hidden;
  font-size: 0;
  display: flex;
...
.anc-6310-counter-09-row:hover{
  background: <?php echo isset($cssData['full_background_hover_color']) && $cssData['full_background_hover_color'] !== '' ? $cssData['full_background_hover_color'] : 'rgba(29, 29, 29, 1)'; ?>;
}
.anc-6310-counter-09 {
  padding-top: 60px;
  padding-bottom: 40px;
  font-family: Amaranth;
  background-color: <?php echo isset($cssData['box_background_color']) && $cssData['box_background_color'] !== '' ? $cssData['box_background_color'] : 'rgba(255, 255, 255, 0)'; ?>;
