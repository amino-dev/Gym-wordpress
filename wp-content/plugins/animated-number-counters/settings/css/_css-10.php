...
.anc-6310-counter-10-paralax:hover{
...
.anc-6310-counter-10 {
  ...
  height: calc(100% - 60px - 2 * <?php echo $cssData['box_border_width'] ?>px);
}
...
.anc-6310-counter-10-description{
  ...
  color: <?php echo isset($cssData['description_font_color']) && $cssData['description_font_color'] !== '' ? $cssData['description_font_color'] : 'rgb(89, 82, 82)'; ?>;
  ...
  margin-top: <?php echo isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? $cssData['description_margin_top'] : 25; ?>px;
...
.anc-6310-counter-10:hover .anc-6310-counter-10-description{
  color: <?php echo isset($cssData['description_font_hover_color']) && $cssData['description_font_hover_color'] !== '' ? $cssData['description_font_hover_color'] : 'rgb(89, 82, 82)'; ?>;
}
