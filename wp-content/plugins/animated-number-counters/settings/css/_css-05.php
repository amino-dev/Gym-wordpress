...
.anc-6310-counter-05-bottom-container {
  position: relative;
  display: inline-block;
  width: calc(70% - <?php echo $cssData['box_border_width'] * 2 ?>px);
  background-color: <?php echo $cssData['box_background_color'] ?>;
  -webkit-border-radius: <?php echo $cssData['box_radius'] ?>%;
  -o-border-radius: <?php echo $cssData['box_radius'] ?>%;
  -moz-border-radius: <?php echo $cssData['box_radius'] ?>%;
  -ms-border-radius: <?php echo $cssData['box_radius'] ?>%;
  border-radius: <?php echo $cssData['box_radius'] ?>%;
  border-style: solid;
