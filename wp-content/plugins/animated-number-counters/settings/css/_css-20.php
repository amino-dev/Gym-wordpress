...
.anc-6310-counter-20-paralax:hover{
...
.anc-6310-counter-20 {
  ...
  height: calc(100% - 100px - 2 * <?php echo $cssData['box_border_width'] ?>px);
}
...
.anc-6310-counter-20-icon i{
  transition: .8s;
  border-right: 2px solid <?php echo $cssData['icon_border_right_color'] ?>;
