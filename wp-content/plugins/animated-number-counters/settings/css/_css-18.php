...
.anc-6310-counter-18 {
  ...
  box-shadow: 0 0 <?php echo ($cssData['box_shadow_blur'] * 2) ?>px <?php echo $cssData['box_shadow_width'] ?>px <?php echo $cssData['box_shadow_color'] ?> !important;  
  ...
  height: calc(100% - 45px - 2 * <?php echo $cssData['box_border_width'] ?>px);
}
.anc-6310-counter-18:hover{
  border-color: <?php echo $cssData['box_border_hover_color'] ?>;
  box-shadow: 0 0 <?php echo ($cssData['box_shadow_blur'] * 2) ?>px <?php echo $cssData['box_shadow_width'] ?>px <?php echo $cssData['box_shadow_hover_color'] ?> !important;
...
.anc-6310-counter-18-box-1{
  background-color: <?php echo $cssData['box_background_color_1'] ?> !important;
}
.anc-6310-counter-18-box-1:hover{
  background-color: <?php echo $cssData['box_background_hover_color_1'] ?> !important;
}
.anc-6310-counter-18-box-2{
  background-color: <?php echo $cssData['box_background_color_2'] ?> !important;
}
.anc-6310-counter-18-box-2:hover{
  background-color: <?php echo $cssData['box_background_hover_color_2'] ?> !important;
}
.anc-6310-counter-18-box-3{
  background-color: <?php echo $cssData['box_background_color_3'] ?> !important;
}
.anc-6310-counter-18-box-3:hover{
  background-color: <?php echo $cssData['box_background_hover_color_3'] ?> !important;
}
.anc-6310-counter-18-box-4{
  background-color: <?php echo $cssData['box_background_color_4'] ?> !important;
}
.anc-6310-counter-18-box-4:hover{
  background-color: <?php echo $cssData['box_background_hover_color_4'] ?> !important;
}
.anc-6310-counter-18-box-5{
  background-color: <?php echo $cssData['box_background_color_5'] ?> !important;
}
.anc-6310-counter-18-box-5:hover{
  background-color: <?php echo $cssData['box_background_hover_color_5'] ?> !important;
}
.anc-6310-counter-18-box-6{
  background-color: <?php echo $cssData['box_background_color_6'] ?> !important;
}
.anc-6310-counter-18-box-6:hover{
  background-color: <?php echo $cssData['box_background_hover_color_6'] ?> !important;
}
...
.anc-6310-counter-18-description{
  ...
  margin-left: <?php echo isset($cssData['description_margin_left']) && $cssData['description_margin_left'] !== '' ? $cssData['description_margin_left'] : 8; ?>px;
  margin-right: <?php echo isset($cssData['description_margin_right']) && $cssData['description_margin_right'] !== '' ? $cssData['description_margin_right'] : 8; ?>px;
