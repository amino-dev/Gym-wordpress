<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery("#anc_6310_box_border_width").on("change", function() {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.anc-6310-counter-13 { border-width:" + value + ";} </style>").appendTo(".anc-6310-preview");
        });
        ...
        jQuery("#anc_6310_icon_margin_top").on("change", function() {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.anc-6310-counter-13-icon{  margin-top:" + value + ";} </style>").appendTo(".anc-6310-preview");
        });
