    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#anc_6310_prefix_icon_show_hide').on('click', function() {
            if (jQuery('#anc_6310_prefix_icon_show_hide').prop('checked') == true) {
                ...
                pre_hidden = 2;
                jQuery("<style type='text/css'>.anc-6310-counter-16-count-prefix { display:inline-block;}</style>").appendTo(".anc-6310-preview");
            } else {
                jQuery('.prefix-act-field').hide();
                pre_hidden = 1;
                jQuery("<style type='text/css'>.anc-6310-counter-16-count-prefix { display:none;}</style>").appendTo(".anc-6310-preview");
            }
