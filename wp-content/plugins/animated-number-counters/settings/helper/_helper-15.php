    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#anc_6310_prefix_icon_show_hide').on('click', function() {
            if (jQuery('#anc_6310_prefix_icon_show_hide').prop('checked') == true) {
                ...
                pre_hidden = 2;
                jQuery("<style type='text/css'>.anc-6310-counter-15-count-prefix { display:inline-block;}</style>").appendTo(".anc-6310-preview");
            } else {
                jQuery('.prefix-act-field').hide();
                pre_hidden = 1;
                jQuery("<style type='text/css'>.anc-6310-counter-15-count-prefix { display:none;}</style>").appendTo(".anc-6310-preview");
            }
        ...
        jQuery('#anc_6310_suffix_icon_show_hide').on('click', function() {
            if (jQuery('#anc_6310_suffix_icon_show_hide').prop('checked') == true) {
                ...
                suf_hidden = 2;
                jQuery("<style type='text/css'>.anc-6310-counter-15-count-suffix { display:inline-block;}</style>").appendTo(".anc-6310-preview");
            } else {
                jQuery('.suffix-act-field').hide();
                suf_hidden = 1;
                jQuery("<style type='text/css'>.anc-6310-counter-15-count-suffix { display:none;}</style>").appendTo(".anc-6310-preview");
            }
            calculateWidth(hidden);
        });
       ...
       //Icon Start
        ...
        jQuery("#anc_6310_icon_circle_hover_color").on("change", function() {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'>.anc-6310-counter-15:hover .anc-6310-counter-15-icon{ border-color:" + value + " rgba(0, 0, 0, 0)" + value + value +";} </style>").appendTo(".anc-6310-preview");
        });
