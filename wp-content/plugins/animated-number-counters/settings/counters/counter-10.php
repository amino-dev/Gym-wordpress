<div class="anc-6310-6310">
  <div class="anc-6310-sm">
    ...
    <div class="anc-6310-plugin-setting-left">
      <?php
      include anc_6310_plugin_url . 'settings/form/_form-10.php';
      include anc_6310_plugin_url . 'settings/css/_css-10.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-10.php';
      ?>
              ...
              ?>
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-10">
                    <div class="anc-6310-counter-10-top-wrap">
                    <div class="anc-6310-counter-10-icon"><i class="<?php echo $allCounter['icons'] ?>"></i></div>
                      <div class="anc-6310-counter-10-inner-wrap">
                        <div class="anc-6310-counter-10-number-content">
                          <div class="anc-6310-counter-10-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          <div data-anc-6310-start="0" data-anc-6310-end="<?php echo anc_6310_number_format($allCounter['numbers'])[0] ?>" data-anc-6310-decimals="<?php echo anc_6310_number_format($allCounter['numbers'])[1] ?>" data-anc-6310-once="true" data-anc-6310-duration="<?php echo isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5; ?>" class="anc-6310-counter anc-6310-counter-10-number" data-anc-6310-legacy="false">0</div>
                          <div class="anc-6310-counter-10-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        <div class="anc-6310-counter-10-title"><?php echo $allCounter['title'] ?></div>
                      </div>
                    </div>
                    <div class="anc-6310-counter-10-description"><?php echo $allCounter['description'] ?></div>
                    <?php
                    if ($allCounter['readmore_text'] != '') {
                    ?>
                      <div class="anc-6310-counter-10-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                    <?php
                    }
                    ?>
                  </div>
