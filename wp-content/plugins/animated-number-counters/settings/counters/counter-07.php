<div class="anc-6310-6310">
   <div class="anc-6310-sm">
      ...
      <div class="anc-6310-plugin-setting-left">
         <?php
         include anc_6310_plugin_url . 'settings/form/_form-07.php';
         include anc_6310_plugin_url . 'settings/css/_css-07.php';
         include anc_6310_plugin_url . 'settings/helper/_helper-07.php';
         ?>
            ...
            <div id="anc-6310-number-counter">
               <div class="anc-6310-counter-07-paralax">
                  <div class="anc-6310-counter-07-common-overlay">
                     <div class="anc-6310-counter-07-row">
                        <?php
                        $allCounters = array();
                        if ($counter_order) {
                        ...
                        ?>
                           <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?> no-ml-mr-mb-0 custom-full-width-<?php echo $cssData['item_per_row'] ?>">
                              <div class="anc-6310-counter-07">
                                 <div class="anc-6310-counter-07-count-content">
                                    <div class="anc-6310-counter-07-count-prefix"><?php echo $numbersPosition[0] ?></div>
                                    <div class="anc-6310-counter-07-count-content-inner">
                                    <div data-anc-6310-start="0" data-anc-6310-end="<?php echo anc_6310_number_format($allCounter['numbers'])[0] ?>" data-anc-6310-decimals="<?php echo anc_6310_number_format($allCounter['numbers'])[1] ?>" data-anc-6310-once="true" data-anc-6310-duration="<?php echo isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5; ?>" class="anc-6310-counter anc-6310-counter-07-count-number" data-anc-6310-legacy="false">0</div>
                                    </div>
                                    <div class="anc-6310-counter-07-count-suffix"><?php echo $numbersPosition[1] ?></div>
                                 </div>
                                 <div class="anc-6310-counter-07-count-title"><?php echo $allCounter['title'] ?></div>
                                 <div class="anc-6310-counter-07-count-subtitle"><?php echo $allCounter['description'] ?></div>
                                 <?php
                                    if($allCounter['readmore_text'] != '') {    
                                 ?>
                                 <div class="anc-6310-counter-07-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                                 <?php
                             }
                           ?>
                              </div>
