<div class="anc-6310-6310">
  <div class="anc-6310-sm">
    ...
    <div class="anc-6310-plugin-setting-left">
      <?php
      include anc_6310_plugin_url . 'settings/form/_form-16.php';
      include anc_6310_plugin_url . 'settings/css/_css-16.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-16.php';
      ?>
                  ...
                  <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                    <div class="anc-6310-counter-16">
                      <div class="anc-6310-counter-16-icon">
                        ...
                        <div class="anc-6310-counter-16-number-content">
                          <div class="anc-6310-counter-16-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          <div data-anc-6310-start="0" data-anc-6310-end="<?php echo anc_6310_number_format($allCounter['numbers'])[0] ?>" data-anc-6310-decimals="<?php echo anc_6310_number_format($allCounter['numbers'])[1] ?>" data-anc-6310-once="true" data-anc-6310-duration="<?php echo isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5; ?>" class="anc-6310-counter anc-6310-counter-16-number" data-anc-6310-legacy="false">0</div>
                          <div class="anc-6310-counter-16-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                      </div>
                      <div class="anc-6310-counter-16-title"><?php echo $allCounter['title'] ?></div>
                      <div class="anc-6310-counter-16-description"><?php echo $allCounter['description'] ?></div>
                      <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                      <div class="anc-6310-counter-16-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                      <?php
                             }
                           ?>
                    </div>
