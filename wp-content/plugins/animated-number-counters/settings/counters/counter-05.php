<div class="anc-6310-6310">
  <div class="anc-6310-sm">
    ...
    <div class="anc-6310-plugin-setting-left">
      <?php
      include anc_6310_plugin_url . 'settings/form/_form-05.php';
      include anc_6310_plugin_url . 'settings/css/_css-05.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-05.php';
      ?>
      ...
      <div class="anc_6310_tabs_panel_preview">
        <div id="anc-6310-number-counter">
          <div class="anc-6310-counter-05-paralax">
            <div class="anc-6310-counter-05-common-overlay">
              <div class="anc-6310-counter-05-row">
                <?php
                $allCounters = array();
                if ($counter_order) {
                    ...
                    <div class="anc-6310-counter-05">
                      ...
                      <div class="anc-6310-counter-05-bottom-container">
                        ...
                        <div class="anc-6310-counter-05-count-content">
                          <div class="anc-6310-counter-05-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          ...
                          <div class="anc-6310-counter-05-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        <div class="anc-6310-counter-05-count-title"><?php echo $allCounter['title'] ?></div>
                        <div class="anc-6310-counter-05-description"><?php echo $allCounter['description'] ?></div>
                        <?php
                        if ($allCounter['readmore_text'] != '') {
                        ?>
                          <div class="anc-6310-counter-05-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                        <?php
                        }
                        ?>
                      </div>
