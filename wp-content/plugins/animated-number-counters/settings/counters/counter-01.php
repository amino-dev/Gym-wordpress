<div class="anc-6310-6310">
   <div class="anc-6310-sm">
      ...
      <div class="anc-6310-plugin-setting-left">
         <?php
         include anc_6310_plugin_url . 'settings/form/_form-01.php';
         include anc_6310_plugin_url . 'settings/css/_css-01.php';
         include anc_6310_plugin_url . 'settings/helper/_helper-01.php';
         ?>
         ...
         <div class="anc_6310_tabs_panel_preview">
            <div id="anc-6310-number-counter">
               <div class="anc-6310-counter-row">
               <?php
               $allCounters = array();
               if ($counter_order) {
               ...
               ?>
                  ...
                  <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                     <div class="anc-6310-counter-01">
                        <div class="anc-6310-counter-01-top-container" style="background-image: url('<?php echo $allCounter['image'] ?>');">
                           <div class="anc-6310-counter-01-top-inner-wrap">
                              <div class="anc-6310-counter-01-count-title"><?php echo $allCounter['title'] ?></div>
                           </div>
                        </div>
                        <div class="anc-6310-counter-01-bottom-container">
                           <div class="anc-6310-counter-01-count-content">
                              <div class="anc-6310-counter-01-count-content-inner">
                                 <div class="anc-6310-counter-01-count-prefix"><?php echo $numbersPosition[0] ?></div>
                                 <div data-anc-6310-start="0" data-anc-6310-end="<?php echo anc_6310_number_format($allCounter['numbers'])[0] ?>" data-anc-6310-decimals="<?php echo anc_6310_number_format($allCounter['numbers'])[1] ?>" data-anc-6310-once="true" data-anc-6310-duration="<?php echo isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5; ?>" class="anc-6310-counter anc-6310-counter-01-count-number" data-anc-6310-legacy="false">0</div>
                                 <div class="anc-6310-counter-01-count-suffix"><?php echo $numbersPosition[1] ?></div>
                              </div>
                           </div>
                           <div class="anc-6310-counter-01-count-subtitle"><?php echo $allCounter['description'] ?></div>
                           <?php
                           if ($allCounter['readmore_text'] != '') {
                           ?>
                              <div class="anc-6310-counter-01-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                           <?php
                           }
                           ?>
                        </div>
