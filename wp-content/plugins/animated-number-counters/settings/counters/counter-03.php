<div class="anc-6310-6310">
   <div class="anc-6310-sm">
      ...
      <div class="anc-6310-plugin-setting-left">
         <?php
         include anc_6310_plugin_url . 'settings/form/_form-03.php';
         include anc_6310_plugin_url . 'settings/css/_css-03.php';
         include anc_6310_plugin_url . 'settings/helper/_helper-03.php';
         ?>
            ...
            <div id="anc-6310-number-counter">
               <div class="anc-6310-counter-03-paralax">
                  <div class="anc-6310-counter-03-common-overlay">
                     <div class="anc-6310-counter-03-row">
                        <?php
                        $allCounters = array();
                        if ($counter_order) {
                           ...
                           <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                              <div class="anc-6310-counter-03">
                                 <div class="anc-6310-counter-03-featured-item">
                                    <span><i class="<?php echo $allCounter['icons'] ?>"></i></span>
                                 </div>
                                 <div class="anc-6310-counter-03-count-content-inner">
                                    <div class="anc-6310-counter-03-count-content">
                                       <div class="anc-6310-counter-03-count-prefix"><?php echo $numbersPosition[0] ?></div>
                                       ...
                                       <div class="anc-6310-counter-03-count-suffix"><?php echo $numbersPosition[1] ?></div>
                                    </div>
                                    <div class="anc-6310-counter-03-count-title"><?php echo $allCounter['title'] ?></div>
                                    <div class="anc-6310-counter-03-description"><?php echo $allCounter['description'] ?></div>
                                    <?php
                                    if ($allCounter['readmore_text'] != '') {
                                    ?>
                                       <div class="anc-6310-counter-03-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo $allCounter['readmore_text'] ?></a></div>
                                    <?php
                                    }
                                    ?>
                                 </div>
