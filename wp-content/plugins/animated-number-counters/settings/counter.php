...
<div class="anc-6310">
            ...
            <div class="anc-6310-modal-body-form">
              <table border="0" width="100%" cellpadding="10" cellspacing="0">
                <tr>
                  ...
                  <td><input type="text" name="title" id="title" value="<?php echo $counter['title'] ?>" class="anc-6310-form-input lg" placeholder="Counter Title" /></td>
                </tr>
                <tr>
                  <td><label class="anc-6310-form-label" for="description">Description:</label></td>
                  <td>
                    <textarea name="description" id="description" class="anc-6310-form-input lg"><?php echo $counter['description'] ?></textarea>
                  </td>
                </tr>
                <tr>
              ...
              <td><input type="text" name="number_prefix" id="number_prefix" value="<?php echo $numbersPosition[0] ?>" class="anc-6310-form-input lg" placeholder="Number Prefix" /></td>
                ...
                <tr>
                  <td style="width: 150px;"><label class="anc-6310-form-label" for="numbers">Number:</label></td>
                  <td><input type="text" name="numbers" id="numbers" value="<?php echo $counter['numbers'] ?>" class="anc-6310-form-input lg" placeholder="Number" /></td>
                </tr>
                <tr>
                ...
                <tr height="40px" class="anc-6310-form-icon" id="1">
                ...
                <tr>
                  ...
                  <td><input type="text" name="readmore_text" id="readmore" value="<?php echo $counter['readmore_text'] ?>" class="anc-6310-form-input lg" placeholder="Read More"></td>
                </tr>
                <tr>
  ...
  <table class="anc-6310-table">
    <tr>
      ...
      <td>Description</td>
      <td style="width: 80px">Numbers</td>
    ...
    foreach ($data as $value) {
      ...
      echo '<td align="center">' . $value['readmore_text'] . '</td>';
      echo '<td>
                 <form method="post">
      ...
      <form action="" method="post">
        ...
        <div class="anc-6310-modal-body-form">
          ...
          <table border="0" width="100%" cellpadding="10" cellspacing="0">
            ...
            <tr>
              <td style="width: 150px;"><label class="anc-6310-form-label" for="numbers">Number:</label></td>
              <td><input type="text" name="numbers" id="numbers" value="" class="anc-6310-form-input lg" placeholder="Number" /></td>
            </tr>
            <tr>
