          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="image_overlay_color" id="anc_6310_image_overlay_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['image_overlay_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Image Overlay Hover Color</b></td>
                <td>
                  <input type="text" name="image_overlay_hover_color" id="anc_6310_image_overlay_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['image_overlay_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type=
                  "number" value="<?php echo isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? $cssData['description_margin_top'] : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Bottom</b></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="text" name="number_background_color" id="anc_6310_number_background_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['number_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Background Hover Color</b></td>
                <td>
                  <input type="text" name="number_background_hover_color" id="anc_6310_number_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['number_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Number Box Size</b></td>
                <td>
                  <input type="number" min="0" name="number_box_size" value="<?php echo $cssData['number_box_size'] ?>" class="anc-6310-form-input" id="anc_6310_number_box_size">
                </td>
              </tr>
              <tr height="45">
                <td><b>Number Box Radius</b></td>
                <td>
                  <input type="number" min="0" name="number_box_radius" value="<?php echo $cssData['number_box_radius'] ?>" class="anc-6310-form-input" id="anc_6310_number_box_radius" />
                </td>
              </tr>
              <tr height="45">
                <td width='55%'>
