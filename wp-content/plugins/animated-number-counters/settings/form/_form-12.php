        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Icon Line Height</b></td>
                <td>
                  <input type="number" name="icon_line_height" value="<?php echo $cssData['icon_line_height'] ?>" class="anc-6310-form-input" id="anc_6310_icon_line_height" />
                </td>
              </tr>
              <tr height="45">
