          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color" id="anc_6310_box_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_color" id="anc_6310_box_border_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_border_color'] ?>">
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_shadow_color" id="anc_6310_box_shadow_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".2" data-format="rgb" value="<?php echo $cssData['box_shadow_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Shadow Hover Color</b></td>
                <td>
                  <input type="text" name="box_shadow_hover_color" id="anc_6310_box_shadow_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".4" data-format="rgb" value="<?php echo $cssData['box_shadow_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                <td width='55%'><b>Font Size</b></td>
                <td>
                  <input type="number" min="0" name="description_font_size" value="<?php echo $cssData['description_font_size'] ?>" class="anc-6310-form-input" step="1" id="anc_6310_description_font_size" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Line Height</b></td>
                <td>
                  <input name="description_line_height" id="anc_6310_description_line_height" type="number" value="<?php echo $cssData['description_line_height'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Font Color</b></td>
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['description_font_color'] ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Font Hover Color</b></td>
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['description_font_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td width='55%'><b>Font Weight</b></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                <td><b>Font Family</b></td>
                <td>
                  <input name="description_font_family" id="anc_6310_jquery_description_font" type="text" value="<?php echo $cssData['description_font_family'] ?>" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Left</b></td>
                <td>
                  <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo $cssData['description_margin_left'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Right</b></td>
                <td>
                  <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo $cssData['description_margin_right'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo $cssData['description_margin_top'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="description_margin_bottom" id="anc_6310_description_margin_bottom" type="number" value="<?php echo $cssData['description_margin_bottom'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Line Height</b></td>
                <td>
                  <input name="number_line_height" id="anc_6310_number_line_height" type="number" value="<?php echo $cssData['number_line_height'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Color</b></td>
