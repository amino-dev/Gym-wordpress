        ...
        <div class="row anc_6310_padding_15_px">
          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                <td><b>Box One Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_1" id="anc_6310_box_background_color_1" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_1'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box One Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_1" id="anc_6310_box_background_hover_color_1" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_1'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Two Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_2" id="anc_6310_box_background_color_2" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_2'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Two Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_2" id="anc_6310_box_background_hover_color_2" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_2'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Three Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_3" id="anc_6310_box_background_color_3" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_3'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Three Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_3" id="anc_6310_box_background_hover_color_3" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_3'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Four Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_4" id="anc_6310_box_background_color_4" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_4'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Four Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_4" id="anc_6310_box_background_hover_color_4" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_4'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Five Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_5" id="anc_6310_box_background_color_5" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_5'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td width="55%"><b>Box Five Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_5" id="anc_6310_box_background_hover_color_5" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_5'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Six Background Color</b></td>
                <td>
                  <input type="text" name="box_background_color_6" id="anc_6310_box_background_color_6" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color_6'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Six Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color_6" id="anc_6310_box_background_hover_color_6" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color_6'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Radius</b></td>
                <td>
                  <input type="number" min="0" name="box_radius" value="<?php echo $cssData['box_radius'] ?>" class="anc-6310-form-input" id="anc_6310_box_radius" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Border Width</b></td>
                <td>
                  <input type="number" min="0" name="box_border_width" value="<?php echo $cssData['box_border_width'] ?>" class="anc-6310-form-input" id="anc_6310_box_border_width" />
                </td>
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_color" id="anc_6310_box_border_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".55" value="<?php echo $cssData['box_border_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Border Hover Color</b></td>
                <td>
                  <input type="text" name="box_border_hover_color" id="anc_6310_box_border_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_border_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Shadow Width</b></td>
                <td>
                  <input type="number" min="0" name="box_shadow_width" value="<?php echo $cssData['box_shadow_width'] ?>" class="anc-6310-form-input" id="anc_6310_box_shadow_width" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Shadow Blur</b></td>
                <td>
                  <input type="number" min="0" name="box_shadow_blur" value="<?php echo $cssData['box_shadow_blur'] ?>" class="anc-6310-form-input" id="anc_6310_box_shadow_blur" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Shadow Color</b></td>
                <td>
                  <input type="text" name="box_shadow_color" id="anc_6310_box_shadow_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_shadow_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Shadow Hover Color</b></td>
                <td>
                  <input type="text" name="box_shadow_hover_color" id="anc_6310_box_shadow_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_shadow_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="title_font_size" value="<?php echo $cssData['title_font_size'] ?>" class="anc-6310-form-input" step="1" id="anc_6310_title_font_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Line Height</b></td>
                <td>
                  <input name="title_line_height" id="anc_6310_heading_line_height" type="number" value="<?php echo $cssData['title_line_height'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Color</b></td>
                <td>
                  <input type="text" name="title_font_color" id="anc_6310_title_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['title_font_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Hover Color</b></td>
                <td>
                  <input type="text" name="title_font_hover_color" id="anc_6310_title_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['title_font_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                <td width='55%'><b>Text Transform</b></td>
                <td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input name="title_font_family" id="anc_6310_jquery_heading_font" type="text" value="<?php echo $cssData['title_font_family'] ?>" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Left</b></td>
                <td>
                  <input name="title_margin_left" id="anc_6310_title_margin_left" type="number" value="<?php echo $cssData['title_margin_left'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Right</b></td>
                <td>
                  <input name="title_margin_right" id="anc_6310_title_margin_right" type="number" value="<?php echo $cssData['title_margin_right'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="title_margin_top" id="anc_6310_title_margin_top" type="number" value="<?php echo $cssData['title_margin_top'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="title_margin_bottom" id="anc_6310_title_margin_bottom" type="number" value="<?php echo $cssData['title_margin_bottom'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td><b>Icon Size</b></td>
                <td>
                  <input type="number" name="icon_size" value="<?php echo $cssData['icon_size'] ?>" class="anc-6310-form-input" id="anc_6310_icon_size">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Color</b></td>
                <td>
                  <input type="text" name="icon_color" id="anc_6310_icon_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Hover Color</b></td>
                <td>
                  <input type="text" name="icon_hover_color" id="anc_6310_icon_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['icon_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon-Number Align</b></td>
                <td>
                  <select name="icon_text_align" class="anc-6310-form-input" id="anc_6310_icon_text_align">
                    <option value="center" <?php if ($cssData['icon_text_align'] == 'center') echo " selected=''" ?>>Center</option>
                    <option value="flex-start" <?php if ($cssData['icon_text_align'] == 'left' || $cssData['icon_text_align'] == 'flex-start') echo " selected=''" ?>>Left</option>
                    <option value="flex-end" <?php if ($cssData['icon_text_align'] == 'right' || $cssData['icon_text_align'] == 'flex-end') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td><b>Margin Left</b></td>
                <td>
                  <input name="icon_margin_left" id="anc_6310_icon_margin_left" type="number" value="<?php echo $cssData['icon_margin_left'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Right</b></td>
                <td>
                  <input name="icon_margin_right" id="anc_6310_icon_margin_right" type="number" value="<?php echo $cssData['icon_margin_right'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="icon_margin_top" id="anc_6310_icon_margin_top" type="number" value="<?php echo $cssData['icon_margin_top'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="icon_margin_bottom" id="anc_6310_icon_margin_bottom" type="number" value="<?php echo $cssData['icon_margin_bottom'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="number" min="0" name="description_font_size" value="<?php echo isset($cssData['description_font_size']) && $cssData['description_font_size'] !== '' ? $cssData['description_font_size'] : 15; ?>" class="anc-6310-form-input" step="1" id="anc_6310_description_font_size" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Line Height </b>
                ...
                <td>
                  <input name="description_line_height" id="anc_6310_description_line_height" type="number" value="<?php echo isset($cssData['description_line_height']) && $cssData['description_line_height'] !== '' ? $cssData['description_line_height'] : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Font Color </b>
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <select name="description_text_transform" class="anc-6310-form-input" id="anc_6310_description_text_transform">
                    ...
                    <option value="none" <?php if (isset($cssData['description_text_transform']) && $cssData['description_text_transform'] == 'none') echo " selected=''" ?>>As Input</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_font_family" id="anc_6310_jquery_description_font" type="text" value="<?php echo isset($cssData['description_font_family']) && $cssData['description_font_family'] !== '' ? str_replace("+", " ", $cssData['description_font_family']) : 'roboto'; ?>" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Left </b>
                ...
                <td>
                  <input name="description_margin_left" id="anc_6310_description_margin_left" type="number" value="<?php echo isset($cssData['description_margin_left']) && $cssData['description_margin_left'] !== '' ? $cssData['description_margin_left'] : 8; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Right </b>
                ...
                <td>
                  <input name="description_margin_right" id="anc_6310_description_margin_right" type="number" value="<?php echo isset($cssData['description_margin_right']) && $cssData['description_margin_right'] !== '' ? $cssData['description_margin_right'] : 8; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                <td><b>Margin Top </b>
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? $cssData['description_margin_top'] : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_bottom" id="anc_6310_description_margin_bottom" type="number" value="<?php echo isset($cssData['description_margin_bottom']) && $cssData['description_margin_bottom'] !== '' ? $cssData['description_margin_bottom'] : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
      ...
      <div id="tab-5">
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
            <tr height="45">
                <td width='55%'><b>Number Font Size</b></td>
                <td>
                  <input type="number" min="0" name="number_font_size" value="<?php echo $cssData['number_font_size'] ?>" class="anc-6310-form-input" id="anc_6310_number_font_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Line Height</b></td>
                <td>
                  <input type="number" name="number_line_height" value="<?php echo $cssData['number_line_height'] ?>" class="anc-6310-form-input" id="anc_6310_number_line_height" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Color</b></td>
                <td>
                  <input type="text" name="number_font_color" id="anc_6310_number_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['number_font_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Hover Color</b></td>
                <td>
                  <input type="text" name="number_font_hover_color" id="anc_6310_number_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo $cssData['number_font_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Font Weight</b></td>
              ...
              <tr height="45">
                <td><b>Font Family</b></td>
                <td>
                  <input name="number_font_family" id="anc_6310_jquery_number_font" type="text" value="<?php echo $cssData['number_font_family'] ?>" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Left</b></td>
                <td>
                  <input name="number_margin_left" id="anc_6310_number_margin_left" type="number" value="<?php echo $cssData['number_margin_left'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Right</b></td>
                <td>
                  <input name="number_margin_right" id="anc_6310_number_margin_right" type="number" value="<?php echo $cssData['number_margin_right'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="number_margin_top" id="anc_6310_number_margin_top" type="number" value="<?php echo $cssData['number_margin_top'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="number_margin_bottom" id="anc_6310_number_margin_bottom" type="number" value="<?php echo $cssData['number_margin_bottom'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              <tr height="45">
                <td width="55%"><b>Activate Number Prefix</b></td>
                <td>
                  <label class="switch">
              ...
              <tr height="45">
                <td width="55%"><b>Activate Number Suffix</b></td>
                <td>
                  <label class="switch">
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="button-act-field">
                <td width="55%"><b>Background Hover Color </b>
                </td>
                <td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                <td width='55%'><b>Button Text Align </b>
                </td>
                <td>
              ...
              <tr height="45" class="button-act-field">
                <td width='55%'><b>Button Border Width </b>
                </td>
                <td>
              ...
              <tr height="45" class="button-act-field">
                <td><b>Button Border Hover Color </b>
                </td>
                <td>
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_top" id="anc_6310_button_margin_top" type="number" value="<?php echo isset($cssData['button_margin_top']) && $cssData['button_margin_top'] !== '' ? $cssData['button_margin_top'] : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="button-act-field">
                <td><b>Margin Bottom </b>
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && $cssData['button_margin_bottom'] !== '' ? $cssData['button_margin_bottom'] : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
