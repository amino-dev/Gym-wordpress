        ...
        <div class="row anc_6310_padding_15_px">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Full Background Color</b></td>
                <td>
                  <input type="text" name="full_background_color" id="anc_6310_full_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".75" value="<?php echo $cssData['full_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Full Background Hover Color</b></td>
                <td>
                  <input type="text" name="full_background_hover_color" id="anc_6310_full_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".75" data-format="rgb" value="<?php echo $cssData['full_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td width='55%'><b>Icon Border Right Color</b></td>
                <td>
                  <input type="text" name="icon_border_right_color" id="anc_6310_icon_border_right_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_border_right_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Border Right Hover Color</b></td>
                <td>
                  <input type="text" name="icon_border_right_hover_color" id="anc_6310_icon_border_right_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['icon_border_right_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
