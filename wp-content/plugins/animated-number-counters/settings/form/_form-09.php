          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo isset($cssData['box_background_color']) && $cssData['box_background_color'] !== '' ? $cssData['box_background_color'] : 'rgba(255, 255, 255, 0)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color" id="anc_6310_box_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo isset($cssData['box_background_hover_color']) && $cssData['box_background_hover_color'] !== '' ? $cssData['box_background_hover_color'] : 'rgba(255, 255, 255, 0)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Box Radius</b></td>
                <td>
                  <input type="number" min="0" name="box_radius" value="<?php echo isset($cssData['box_radius']) && $cssData['box_radius'] !== '' ? $cssData['box_radius'] : 0; ?>" class="anc-6310-form-input" id="anc_6310_box_radius" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="full_background_color" id="anc_6310_full_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".75" value="<?php echo isset($cssData['full_background_color']) && $cssData['full_background_color'] !== '' ? $cssData['full_background_color'] : 'rgba(29, 29, 29, 1)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Full Background Hover Color</b></td>
                <td>
                  <input type="text" name="full_background_hover_color" id="anc_6310_full_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".75" data-format="rgb" value="<?php echo isset($cssData['full_background_hover_color']) && $cssData['full_background_hover_color'] !== '' ? $cssData['full_background_hover_color'] : 'rgba(29, 29, 29, 1)'; ?>">
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="title_font_size" value="<?php echo isset($cssData['title_font_size']) && $cssData['title_font_size'] !== '' ? $cssData['title_font_size'] : 20; ?>" class="anc-6310-form-input" step="1" id="anc_6310_title_font_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Line Height</b></td>
                <td>
                  <input name="title_line_height" id="anc_6310_heading_line_height" type="number" value="<?php echo isset($cssData['title_line_height']) && $cssData['title_line_height'] !== '' ? $cssData['title_line_height'] : 20; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input name="title_margin_top" id="anc_6310_title_margin_top" type="number" value="<?php echo isset($cssData['title_margin_top']) && $cssData['title_margin_top'] !== '' ? $cssData['title_margin_top'] : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="title_margin_bottom" id="anc_6310_title_margin_bottom" type="number" value="<?php echo isset($cssData['title_margin_bottom']) && $cssData['title_margin_bottom'] !== '' ? $cssData['title_margin_bottom'] : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td><b>Icon Size</b></td>
                <td>
                  <input type="number" name="icon_size" value="<?php echo isset($cssData['icon_size']) && $cssData['icon_size'] !== '' ? $cssData['icon_size'] : 30; ?>" class="anc-6310-form-input" id="anc_6310_icon_size">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Color</b></td>
                <td>
                  <input type="text" name="icon_color" id="anc_6310_icon_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo isset($cssData['icon_color']) && $cssData['icon_color'] !== '' ? $cssData['icon_color'] : 'rgba(1,170,193, 1)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Hover Color</b></td>
                <td>
                  <input type="text" name="icon_hover_color" id="anc_6310_icon_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo isset($cssData['icon_hover_color']) && $cssData['icon_hover_color'] !== '' ? $cssData['icon_hover_color'] : 'rgb(255, 255, 255)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Icon Background Color</b></td>
                <td>
                  <input type="text" name="icon_background_color" id="anc_6310_icon_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".75" value="<?php echo isset($cssData['icon_background_color']) && $cssData['icon_background_color'] !== '' ? $cssData['icon_background_color'] : 'rgba(255, 255, 255, 0.08)'; ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Icon Background Hover Color</b></td>
                <td>
                  <input type="text" name="icon_background_hover_color" id="anc_6310_icon_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".75" data-format="rgb" value="<?php echo isset($cssData['icon_background_hover_color']) && $cssData['icon_background_hover_color'] !== '' ? $cssData['icon_background_hover_color'] : 'rgba(1, 170, 193, 1)'; ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
              ...
              <tr height="45">
                <td><b>Margin Right</b></td>
                <td>
                  <input name="icon_margin_right" id="anc_6310_icon_margin_right" type="number" value="<?php echo isset($cssData['icon_margin_right']) && $cssData['icon_margin_right'] !== '' ? $cssData['icon_margin_right'] : 10; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="number" min="0" name="number_font_size" value="<?php echo isset($cssData['number_font_size']) && $cssData['number_font_size'] !== '' ? $cssData['number_font_size'] : 35; ?>" class="anc-6310-form-input" id="anc_6310_number_font_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Line Height</b></td>
                <td>
                  <input type="number" min="0" name="number_line_height" value="<?php echo isset($cssData['number_line_height']) && $cssData['number_line_height'] !== '' ? $cssData['number_line_height'] : 35; ?>" class="anc-6310-form-input" id="anc_6310_number_line_height" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Font Color</b></td>
              ...
              <tr height="45">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="number_margin_top" id="anc_6310_number_margin_top" type="number" value="<?php echo isset($cssData['number_margin_top']) && $cssData['number_margin_top'] !== '' ? $cssData['number_margin_top'] : 0; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
