        ...
        <div class="row anc_6310_padding_15_px">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Box Padding</b></td>
                <td>
                  <input name="box_padding" id="anc_6310_box_padding" type="number" value="<?php echo $cssData['box_padding'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
                <td>
                  <input name="box_margin_top" id="anc_6310_box_margin_top" type="number" value="<?php echo $cssData['box_margin_top'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b></td>
                <td>
                  <input name="box_margin_bottom" id="anc_6310_box_margin_bottom" type="number" value="<?php echo $cssData['box_margin_bottom'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Icon Padding</b></td>
                <td>
                  <input name="icon_padding" id="anc_6310_icon_padding" type="number" value="<?php echo $cssData['icon_padding'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Icon Size</b></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td width='55%'><b>Arrow Color</b></td>
                <td>
                  <input type="text" name="arrow_color" id="anc_6310_arrow_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['arrow_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Arrow Hover Color</b></td>
                <td>
                  <input type="text" name="arrow_hover_color" id="anc_6310_arrow_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['arrow_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_bottom" id="anc_6310_button_margin_bottom" type="number" value="<?php echo isset($cssData['button_margin_bottom']) && $cssData['button_margin_bottom'] !== '' ? $cssData['button_margin_bottom'] : 5; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
