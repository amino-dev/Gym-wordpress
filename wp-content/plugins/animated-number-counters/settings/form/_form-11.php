      ...
      <div id="tab-3">
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td width='55%'><b>Icon Background Color</b></td>
                <td>
                  <input type="text" name="icon_background_color" id="anc_6310_icon_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Background Hover Color</b></td>
                <td>
                  <input type="text" name="icon_background_hover_color" id="anc_6310_icon_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['icon_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Icon Background Size</b></td>
                <td>
                  <input type="number" min="0" name="icon_background_size" value="<?php echo $cssData['icon_background_size'] ?>" class="anc-6310-form-input" id="anc_6310_icon_background_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Icon Background Radius</b></td>
                <td>
                  <input type="number" min="0" name="icon_background_radius" value="<?php echo $cssData['icon_background_radius'] ?>" class="anc-6310-form-input" id="anc_6310_icon_background_radius" />
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_color']) && $cssData['description_font_color'] !== '' ? $cssData['description_font_color'] : 'rgb(0, 0, 0)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_hover_color']) && $cssData['description_font_hover_color'] !== '' ? $cssData['description_font_hover_color'] : 'rgb(0, 0, 0)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="button-act-field">
                ...
                <td>
                  <input name="button_margin_top" id="anc_6310_button_margin_top" type="number" value="<?php echo isset($cssData['button_margin_top']) && $cssData['button_margin_top'] !== '' ? $cssData['button_margin_top'] : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="button-act-field">
                <td><b>Margin Bottom </b>
