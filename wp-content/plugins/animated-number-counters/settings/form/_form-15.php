        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td width='55%'><b>Icon Circle Color</b></td>
                <td>
                  <input type="text" name="icon_circle_color" id="anc_6310_icon_circle_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_circle_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width='55%'><b>Icon Circle Hover Color</b></td>
                <td>
                  <input type="text" name="icon_circle_hover_color" id="anc_6310_icon_circle_hover_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_circle_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
