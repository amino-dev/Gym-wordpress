          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" step="1" data-opacity="0" data-format="rgb" value="<?php echo $cssData['box_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Box Background Hover Color</b></td>
                <td>
                  <input type="text" name="box_background_hover_color" id="anc_6310_box_background_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".5" data-format="rgb" value="<?php echo $cssData['box_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                ...
                <td>
                  <input type="text" name="image_overlay_color" id="anc_6310_image_overlay_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".75" value="<?php echo $cssData['image_overlay_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Image Overlay Hover Color</b></td>
                <td>
                  <input type="text" name="image_overlay_hover_color" id="anc_6310_image_overlay_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".75" data-format="rgb" value="<?php echo $cssData['image_overlay_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_image" id="anc_6310_box_background_image" class="anc-6310-form-input" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_background_image'] ?>">
                  <input type="button" id="anc_6310_box_background_image_button" value="Upload Image" class="anc-6310-btn-default" style='margin-top: 5px;'>
                </td>
              </tr>
            </table>
          </div>
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Icon Circle Size</b></td>
                <td>
                  <input type="number" min="0" name="icon_circle_size" value="<?php echo $cssData['icon_circle_size'] ?>" class="anc-6310-form-input" id="anc_6310_icon_circle_size" />
                </td>
              </tr>
              <tr height="45">
                <td><b>Icon Circle Border Width</b></td>
                <td>
                  <input type="number" min="0" name="icon_circle_border_width" value="<?php echo $cssData['icon_circle_border_width'] ?>" class="anc-6310-form-input" id="anc_6310_icon_circle_border_width" />
                </td>
              </tr>
              <tr height="45">
              ...
              <tr height="45">
                <td width="55%"><b>Icon Left-Circle Color</b></td>
                <td>
                  <input type="text" name="icon_left_circle_color" id="anc_6310_icon_left_circle_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo $cssData['icon_left_circle_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              <tr height="45">
                <td width="55%"><b>Icon Left-Circle Hover Color</b></td>
                <td>
                  <input type="text" name="icon_left_circle_hover_color" id="anc_6310_icon_left_circle_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo $cssData['icon_left_circle_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Icon Right-Circle Color</b></td>
                <td>
                  <input type="text" name="icon_right_circle_color" id="anc_6310_icon_right_circle_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo $cssData['icon_right_circle_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td width="55%"><b>Icon Right-Circle Hover Color</b></td>
                <td>
                  <input type="text" name="icon_right_circle_hover_color" id="anc_6310_icon_right_circle_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity="1" data-format="rgb" value="<?php echo $cssData['icon_right_circle_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Top</b></td>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table" width="100%">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_color" id="anc_6310_description_font_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_color']) && $cssData['description_font_color'] !== '' ? $cssData['description_font_color'] : 'rgb(82, 76, 76)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input type="text" name="description_font_hover_color" id="anc_6310_description_font_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" value="<?php echo isset($cssData['description_font_hover_color']) && $cssData['description_font_hover_color'] !== '' ? $cssData['description_font_hover_color'] : 'rgb(82, 76, 76)'; ?>">
                </td>
              </tr>
              <tr height="45" class="description-act-field">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45" class="description-act-field">
                ...
                <td>
                  <input name="description_margin_top" id="anc_6310_description_margin_top" type="number" value="<?php echo isset($cssData['description_margin_top']) && $cssData['description_margin_top'] !== '' ? $cssData['description_margin_top'] : 15; ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45" class="description-act-field">
