        ...
        (n = [
          {
            ...
            value: function () {
              var e = this,
                t = document.querySelectorAll(".anc-6310-counter");
            ...
            value: function (e, t) {
              ...
              e.forEach(function (e) {
                ...
                return r.duration <= 0
                  ...
                  ? (e.target.innerHTML = r.start > r.end ? r.end : r.start)
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              (e.innerHTML = i),
                !0 === t.once && e.setAttribute("data-anc-6310-duration", 0);
            ...
            value: function (e) {
              for (
                var t = [].filter.call(e.attributes, function (e) {
                    return /^data-anc-6310-/.test(e.name);
                  }),
                  n = {
                    start: 0,
                    end: 9001,
                ...
                var a = t[r].name.replace("data-anc-6310-", "");
                n[a.toLowerCase()] =
                  "duration" == a.toLowerCase()
                    ? parseInt(1e3 * this.castDataType(t[r].value))
