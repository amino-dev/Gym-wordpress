        ...
        <ul>
			...
			foreach($wanted_providers as $key) {
				...
				if(!empty($enabled_providers[$key]['enable'])) {
					...
					?>
                    <li class="xs-share-li <?php echo $key; ?>
                        <?php echo Settings::get_extra_data_class($selected_share_style, $styles) ?>">
                        <a href="javascript:void();"
                           id="xs_feed_<?php echo $key ?>"
                           onclick="xs_social_sharer(this);"
                           data-pid="<?php echo $postId ?>"
                           data-uri_hash="<?php echo $uri_hash ?>"
                           data-key="<?php echo $key; ?>"
                           data-xs-href="<?php echo $getUrl . '?' . $params; ?>">
