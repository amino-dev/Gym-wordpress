                    ...
                    <li>
                        <div class="xs-single-social-block <?php echo $k; ?>">
                            <div class="xs-block-header" data-type="modal-trigger"
                                 data-target="example-modal-<?php echo $k; ?>">
                                <span class="drag-icon"></span>
                                <span class="wslu-social-icon met-social met-social-<?php echo $k; ?>"></span>
                ...
                <div class="xs-modal-content post__tab">
                    <div class="xs-modal-header clear-both">
                        <div class="tabHeader">
                            <ul class="tab__list clear-both">
                                <li class="<?php echo $classSet== 'getting' ? 'active' : ''; ?> tab__list__item"><?php echo esc_html__('Getting Started', 'wp-social'); ?></li>
                                <li class="<?php echo $classSet== 'setting' ? 'active' : ''; ?> tab__list__item"><?php echo esc_html__('Settings', 'wp-social'); ?></li>
                                <li class="<?php echo $classSet== 'button' ? 'active' : '';  ?> tab__list__item"><?php echo esc_html__('Buttons', 'wp-social'); ?></li>
                    ...
                    <div class="xs-modal-body">
                        <div class="ekit--tab__post__details tabContent">
                            ...
                            <div class="tabItem <?php echo $classSet == 'getting' ? 'active' : ''; ?>">
                                    ...
                                    <div class="wslu-popup-data">
                                        ...
                                        <div class="wslu-single-popup-item">
                                            ...
                                            <ol class="xs_social_ol">
                                                ...
                                                <li>
													<?php echo __('Check how to create App/Project On ' . $valueTypeAll . ' developer account - ', 'wp-social') ?>
                                                    <a href="<?php echo esc_url($api_ins['doc_url']) ?>"
                                                       target="_blank"><?php echo $api_ins['doc_url'] ?></a>
                                                </li>

                                                <li>
													<?php
													echo esc_html__('Must add the following URL to the "Valid OAuth redirect URIs" field: ', 'wp-social');
													echo __(' <strong>' . esc_url(get_site_url() . '/wp-json/wslu-social-login/type/' . $keyTypeAll) . '</strong>');
													echo '<br>'.esc_html($api_ins['local_ins']);
													?>
                                                </li>
                            ...
                            <div class="tabItem <?php echo $classSet == 'setting' ? 'active' : ''; ?>">
                                    ...
                                    <div class="wslu-popup-data" id="<?php echo $keyTypeAll; ?>_form_table">
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title" for="<?php echo $keyTypeAll; ?>_appid">
                                                    <?php echo __('App ID - <em>(Required)</em>', 'wp-social'); ?> 
                                                </label>
                                            </div>
                                            <input placeholder="741888455955744"
                                                   name="xs_social[<?php echo $keyTypeAll; ?>][id]" type="text"
                                                   id="<?php echo $keyTypeAll; ?>_appid"
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $keyTypeAll; ?>_secret"><?php echo __('App Secret - <em>(Required)</em>', 'wp-social'); ?></label>
                                            </div>
                                            <input placeholder="32fd74bcaacf588c4572946f201eee8e"
                                                   name="xs_social[<?php echo $keyTypeAll; ?>][secret]" type="text"
                                                   id="<?php echo $keyTypeAll; ?>_secret"
                                ...
                                <div class="button-section">
                                    ...
                                    <div class="wslu-popup-data">
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $keyTypeAll; ?>_login_label"><?php echo esc_html__('Login Label Text ', 'wp-social'); ?> </label>
                                            </div>

                                            <input placeholder="Login with <?php echo $valueTypeAll; ?>"
                                                   name="xs_social[<?php echo $keyTypeAll; ?>][login_label]" type="text"
                                                   id="<?php echo $keyTypeAll; ?>_login_label"
                                                   value="<?php echo esc_html(isset($saved_settings[$keyTypeAll]['login_label']) ? $saved_settings[$keyTypeAll]['login_label'] : 'Login with ' . $valueTypeAll . ''); ?>"
                                                   class="wslu-global-input">
                                        </div>
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $keyTypeAll; ?>_logout_label"><?php echo esc_html__('Logout Label Text ', 'wp-social'); ?> </label>
                                            </div>
                                            <input placeholder="Logout with <?php echo $valueTypeAll; ?>"
                                                   name="xs_social[<?php echo $keyTypeAll; ?>][logout_label]"
                                                   type="text" id="<?php echo $keyTypeAll; ?>_logout_label"
                    ...
                    <div class="xs-modal-footer">
                        <button type="submit" name="xs_provider_submit_form"
                                class="xs-btn btn-special"><?php echo esc_html__('Save Changes'); ?></button>
                    </div>
                </div>
            </div>
		<?php endforeach; ?>
