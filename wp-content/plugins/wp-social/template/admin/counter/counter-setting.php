                ...
                <div class="wslu-single-item">
                    ...
                    <div class="wslu-right-content wslu-inline">
                        ...
                        <label class="social_radio_button_label xs_label_wp_login">
                            <input class="social_radio_button wslu-global-radio-input" type="radio" name="xs_counter[show_font_from_theme]" value="1" <?php echo (!empty($return_data['show_font_from_theme'])) ? 'checked' : ''; ?>>

							<?php echo esc_html__('Yes', 'wp-social'); ?>
                        </label>

                        <label class="social_radio_button_label xs_label_wp_login">
                            <input class="social_radio_button wslu-global-radio-input" type="radio" name="xs_counter[show_font_from_theme]" value="0" <?php echo (empty($return_data['show_font_from_theme'])) ? 'checked' : ''; ?>>
