...
<div class="wslu-social-login-main-wrapper">
	...
	if($message_provider == 'show') { ?>
        <div class="admin-page-framework-admin-notice-animation-container">
            <div 0="XS_Social_Login_Settings"
                 id="XS_Social_Login_Settings"
    ...
    <form action="<?php echo esc_url(admin_url() . 'admin.php?page=wslu_counter_setting&tab=wslu_providers'); ?>"
                    ...
                    ?>
                        <li>
                            <div class="xs-single-social-block <?php echo $k; ?>">
                                ...
                                <div class="xs-block-header" onclick="xs_counter_open(this);"
                                     xs-target-id="<?php echo $js_target_id; ?>">
                                        ...
                                        <div class="configure">
                                            ...
                                            <div class="wslu-single-popup-item wslu-inline">
                                                ...
                                                <input class="social_switch_button" 
                                                    ...
                                                    data-key="<?php echo $k; ?>"
                                                    type="checkbox"
                                                    id="<?php echo $k; ?>_enable"
                                                    name="xs_counter[social][<?php echo $k; ?>][enable]"
                                                    value="1" 
                                                    <?php echo empty($enabled_providers[$k]['enable']) ? '' : 'checked'; ?> />
        ...
        <div class="xs-social-block-wraper-counter">
            ...
            foreach($core_provider as $k => $val) :
				...
				if(strlen($name) > 2) {
					?>
                    <div class="xs-modal-dialog <?php echo ($getType == $k) ? 'is-open' : ''; ?>"
                         id="<?php echo $js_target_id; ?>">
                         <div class="xs-modal-content">
                        
                            <div class="xs-modal-header clear-both">
                                
                                <div class="tabHeader"> <ul class="tab__list clear-both"></ul> </div>
                                <button 
                                    type="button" 
                                    class="xs-btn" 
                                    onclick="xs_counter_open(this);"
                                ...
                                <div class="ekit--tab__post__details tabContent">
                                    ...
                                    <div class="wslu-popup-data">  <?php
                                                        ...
                                                        if(strlen($code) > 0) {
                                                            ...
                                                            $args = array(
                                                                ...
                                                                'body'        => array('grant_type'    => 'authorization_code',
                                                                                    'code'          => $code,
                                                                                    'client_id'     => get_transient('xs_counter_' . $k . '_client_id'),
                                                                                    'client_secret' => get_transient('xs_counter_' . $k . '_client_secret'),
                                                ...
                                                <div class="wslu-single-popup-item <?php echo ($type == 'access') ? 'xs-access-button-inline' : ''; ?>">
                                                    <div class="setting-label-wraper">
                                                        <label class="setting-label wslu-sec-title"
                                                            for="xs_<?php echo $k; ?>_<?php echo $fk; ?>"> <?php echo esc_html__($lavelFIled, 'wp-social'); ?></label>
                                                    </div>
                                                    <?php if($input == 'text') { ?>
                                                        <input name="xs_counter[social][<?php echo $k; ?>][<?php echo $fk; ?>]"
                                                            style="<?php echo ($type == 'access') ? 'cursor: no-drop; opacity: .4;' : ''; ?>"
                                                            type="text" id="xs_<?php echo $k; ?>_<?php echo $fk; ?>"
                                                        ...
                                                        if($show_access_token_grabbed_msg === true) {
                                                            ...
                                                            echo '<div id="'.$div_id.'" style="padding:5px; color:green">Access token grabbed successfully, please save the changes.</div>';

                                                            ?>
                                                            <script>
                                                                setTimeout(function() {
                                                                    jQuery('#<?php echo $div_id ?>').slideUp(1000, hide_the_message);
                                                                }, 5000);                                                        

                                                                function hide_the_message() {
                                                                    
                                                                    jQuery('#<?php echo $div_id ?>').remove();
                                                                }
                                                    ...
                                                    <?php } elseif($input == 'select') {
                                                        ...
                                                        if(is_array($dataSelect)) {
                                                            ...
                                                            <select class="wslu-global-input"
                                                                    name="xs_counter[social][<?php echo $k; ?>][<?php echo $fk; ?>]"
                                                                    id="xs_<?php echo $k; ?>_<?php echo $fk; ?>">
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                    for="xs_<?php echo $k; ?>_text">
                                                    <?php echo esc_html__('Default ' . $setLabel . ' ' . $belowText, 'wp-social'); ?>
                                                </label>
                                            </div>

                                            <input name="xs_counter[social][<?php echo $k; ?>][data][value]"
                                                type="text"
                                                id="xs_<?php echo $k; ?>_text"
                                                value="<?php echo esc_html($belowValue); ?>" class="wslu-global-input">
                                        </div>

                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                    for="xs_<?php echo $k; ?>_text"> <?php echo esc_html__('Text Below The Number', 'wp-social'); ?></label>
                                            </div>

                                            <input name="xs_counter[social][<?php echo $k; ?>][data][text]" type="text"
                                                id="xs_<?php echo $k; ?>_text"
                                                value="<?php echo esc_html($belowText); ?>" class="wslu-global-input">
                                        </div>

                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                    for="xs_<?php echo $k; ?>_label"> <?php echo esc_html__('Label Name', 'wp-social'); ?></label>
                                            </div>

                                            <input name="xs_counter[social][<?php echo $k; ?>][label]" type="text"
                                                id="xs_<?php echo $k; ?>_label"
                                        ...
                                        <div class="wslu-popup-data">
											...
											if(is_array($filedApi)) {
												foreach($filedApi as $fkl => $fvl) {
                                                    ...
                                                    <div class="wslu-single-popup-item">
                                                        <div class="setting-label-wraper">
                                                            <label class="setting-label wslu-sec-title" for="xs_<?php echo $fk; ?>_<?php echo $fkl; ?>">
                                                                <?php echo esc_html__($fvl, 'wp-social'); ?>
                                                            </label>
                                                        </div>

                                                        <input type="text"
                                                               name="accesskey[<?php echo $fk; ?>][<?php echo $fkl; ?>]"
                                                               class="wslu-global-input"
                                                               id="xs_<?php echo $fk; ?>_<?php echo $fkl; ?>"
                                                               value="<?php echo $valueAPp; ?>">
                                                    </div>
													<?php
												}
											}
