                ...
                <div class="wslu-social-style-data">
					...
					foreach($styleArr AS $styleKey => $styleValue) : ?>
                        <div class="wslu-single-social-style-item">
                            ...
                            <label for="_login_button_style__<?= $styleKey; ?>"
                                   class="social_radio_button_label xs_label_wp_login">

                                <input class="social_radio_button wslu-global-radio-input" type="radio"
                                       id="_login_button_style__<?= $styleKey; ?>" name="xs_style[login_button_style]"
                                       value="<?= $styleKey; ?>" <?php echo (isset($saved_style['login_button_style']) && $saved_style['login_button_style'] == $styleKey) ? 'checked' : ''; ?> >

								<?php echo esc_html__($styleValue, 'wp-social') ?>

                                <div class="wslu-style-img xs-login-<?= $styleKey; ?> <?php echo (isset($saved_style['login_button_style']) && $saved_style['login_button_style'] == $styleKey) ? 'style-active ' : ''; ?>">
                                    <img src="<?php echo esc_url(WSLU_LOGIN_PLUGIN_URL . 'assets/images/screenshort/img-' . $td . '.png'); ?>"
                                         alt="style-<?php echo $td; ?>">
                                </div>
                            </label>
                        </div>
						<?php $td++;
