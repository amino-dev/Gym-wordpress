			...
			<div class="global-section">
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__1" class="wslu-input-list deactive_tr  <?php echo isset($return_data['custom_login_url']['enable']) ? 'active_tr' : '';?>">
							<input class="wslu-global-input"  type="text" id="custom_login_url_data" name="xs_global[custom_login_url][data]" value="<?php echo esc_html(isset($return_data['custom_login_url']['data']) ? $return_data['custom_login_url']['data'] : '');?>" >
						</div>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__2" class="wslu-input-list deactive_tr  <?php echo isset($return_data['wp_login_page']['enable']) ? 'active_tr' : '';?>">
								<label class="xs_label_wp_login" for="wp_login_page_data__login_form">
									<input class="wslu-global-radio-input" type="radio" id="wp_login_page_data__login_form" name="xs_global[wp_login_page][data]" value="login_form" <?php echo (isset($return_data['wp_login_page']['data']) && $return_data['wp_login_page']['data'] == 'login_form') ? 'checked' : 'checked'; ?>>
									<?php echo esc_html__('wp login form middle ', 'wp-social')?>
								</label>
								
								<label class="xs_label_wp_login" for="wp_login_page_data__login_head">
									<input class="wslu-global-radio-input" type="radio" id="wp_login_page_data__login_head" name="xs_global[wp_login_page][data]" value="login_head" <?php echo (isset($return_data['wp_login_page']['data']) && $return_data['wp_login_page']['data'] == 'login_head') ? 'checked' : ''; ?>>
									<?php echo esc_html__('wp login form head', 'wp-social')?>
								</label>
								

								<label class="xs_label_wp_login" for="wp_login_page_data__login_footer">
									<input class="wslu-global-radio-input" type="radio" id="wp_login_page_data__login_footer" name="xs_global[wp_login_page][data]" value="login_footer" <?php echo (isset($return_data['wp_login_page']['data']) && $return_data['wp_login_page']['data'] == 'login_footer') ? 'checked' : ''; ?>>
									<?php echo esc_html__('wp login footer ', 'wp-social')?>
								</label>
								
								<label class="xs_label_wp_login" for="wp_login_page_data__login_message">
									<input class="wslu-global-radio-input" type="radio" id="wp_login_page_data__login_message" name="xs_global[wp_login_page][data]" value="login_message" <?php echo (isset($return_data['wp_login_page']['data']) && $return_data['wp_login_page']['data'] == 'login_message') ? 'checked' : ''; ?>>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__3" class="wslu-input-list deactive_tr  <?php echo isset($return_data['wp_register_page']['enable']) ? 'active_tr' : '';?>">
							<label class="xs_label_wp_login" for="wp_register_page_data__register_form">
								<input class="wslu-global-radio-input" type="radio" id="wp_register_page_data__register_form" name="xs_global[wp_register_page][data]" value="register_form" <?php echo (isset($return_data['wp_register_page']['data']) && $return_data['wp_register_page']['data'] == 'register_form') ? 'checked' : 'checked'; ?>>
							...
							<label class="xs_label_wp_login" for="wp_register_page_data__register_head">
								<input class="wslu-global-radio-input" type="radio" id="wp_register_page_data__register_head" name="xs_global[wp_register_page][data]" value="register_head" <?php echo (isset($return_data['wp_register_page']['data']) && $return_data['wp_register_page']['data'] == 'register_head') ? 'checked' : ''; ?>>
							...
							<label class="xs_label_wp_login" for="wp_register_page_data__register_footer">
								<input class="wslu-global-radio-input" type="radio" id="wp_register_page_data__register_footer" name="xs_global[wp_register_page][data]" value="register_footer" <?php echo (isset($return_data['wp_register_page']['data']) && $return_data['wp_register_page']['data'] == 'register_footer') ? 'checked' : ''; ?>>
						...
						<div class="wslu-right-content">
							...
							<div id="xs_data_tr__33" class="wslu-input-list deactive_tr  <?php echo isset($return_data['wfp_fund_login_page']['enable']) ? 'active_tr' : '';?>">
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_form_outer_after">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_form_outer_after" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_after_outer" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_after_outer') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_form_inner_before">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_form_inner_before" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_before_inner" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_before_inner') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_form_inner_after">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_form_inner_after" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_after_inner" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_after_inner') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_login_form_start">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_login_form_start" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_start" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_start') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_login_form_end">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_login_form_end" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_end" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_end') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_login_form_button_after">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_login_form_button_after" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_button_after" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_button_after') ? 'checked' : ''; ?>>
								...
								<label class="xs_label_wp_login" for="wfp_register_page_data__wfp_login_form_message">
									<input class="wslu-global-radio-input" type="radio" id="wfp_register_page_data__wfp_login_form_message" name="xs_global[wfp_fund_login_page][data]" value="wfp_login_form_message" <?php echo (isset($return_data['wfp_fund_login_page']['data']) && $return_data['wfp_fund_login_page']['data'] == 'wfp_login_form_message') ? 'checked' : ''; ?>>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__4" class="wslu-input-list deactive_tr  <?php echo isset($return_data['wp_comment_page']['enable']) ? 'active_tr' : '';?>">
							<label class="xs_label_wp_login" for="wp_comment_page_data__comment_form_top">
								<input class="wslu-global-radio-input" type="radio" id="wp_comment_page_data__comment_form_top" name="xs_global[wp_comment_page][data]" value="comment_form_top" <?php echo (isset($return_data['wp_comment_page']['data']) && $return_data['wp_comment_page']['data'] == 'comment_form_top') ? 'checked' : 'checked'; ?>>
							...
							<label class="xs_label_wp_login" for="wp_comment_page_data__comment_form_must_log_in_after">
								<input class="wslu-global-radio-input" type="radio" id="wp_comment_page_data__comment_form_must_log_in_after" name="xs_global[wp_comment_page][data]" value="comment_form_must_log_in_after" <?php echo (isset($return_data['wp_comment_page']['data']) && $return_data['wp_comment_page']['data'] == 'comment_form_must_log_in_after') ? 'checked' : ''; ?>>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__5" class="wslu-input-list deactive_tr  <?php echo isset($return_data['woocommerce_login_page']['enable']) ? 'active_tr' : '';?>">
							<label class="xs_label_wp_login" for="woocommerce_login_page_data__login_form_start">
								<input class="wslu-global-radio-input" type="radio" id="woocommerce_login_page_data__login_form_start" name="xs_global[woocommerce_login_page][data]" value="woocommerce_login_form_start" <?php echo (isset($return_data['woocommerce_login_page']['data']) && $return_data['woocommerce_login_page']['data'] == 'woocommerce_login_form_start') ? 'checked' : 'checked'; ?>>
							...
							<label class="xs_label_wp_login" for="woocommerce_login_page_data__login_form">
								<input class="wslu-global-radio-input" type="radio" id="woocommerce_login_page_data__login_form" name="xs_global[woocommerce_login_page][data]" value="woocommerce_login_form" <?php echo (isset($return_data['woocommerce_login_page']['data']) && $return_data['woocommerce_login_page']['data'] == 'woocommerce_login_form') ? 'checked' : ''; ?>>
							...
							<label class="xs_label_wp_login" for="woocommerce_login_page_data__login_form_end">
								<input class="wslu-global-radio-input" type="radio" id="woocommerce_login_page_data__login_form_end" name="xs_global[woocommerce_login_page][data]" value="woocommerce_login_form_end" <?php echo (isset($return_data['woocommerce_login_page']['data']) && $return_data['woocommerce_login_page']['data'] == 'woocommerce_login_form_end') ? 'checked' : ''; ?>>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__6" class="wslu-input-list deactive_tr  <?php echo isset($return_data['woocommerce_register_page']['enable']) ? 'active_tr' : '';?>">
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__7" class="wslu-input-list deactive_tr  <?php echo isset($return_data['woocommerce_billing_page']['enable']) ? 'active_tr' : '';?>">
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						...
						<div id="xs_data_tr__8" class="wslu-input-list deactive_tr  <?php echo isset($return_data['buddypress_page']['enable']) ? 'active_tr' : '';?>">
							<label class="xs_label_wp_login" for="buddypress_page_data__bp_before_register_page">
								<input class="wslu-global-radio-input" type="radio" id="buddypress_page_data__bp_before_register_page" name="xs_global[buddypress_page][data]" value="bp_before_register_page" <?php echo (isset($return_data['buddypress_page']['data']) && $return_data['buddypress_page']['data'] == 'bp_before_register_page') ? 'checked' : 'checked'; ?>>
								<?php echo __('BuddyPress before register form ', 'wp-social')?>
							</label>
							
							<label class="xs_label_wp_login" for="buddypress_page_data__bp_before_account_details_fields">
								<input class="wslu-global-radio-input" type="radio" id="buddypress_page_data__bp_before_account_details_fields" name="xs_global[buddypress_page][data]" value="bp_before_account_details_fields" <?php echo (isset($return_data['buddypress_page']['data']) && $return_data['buddypress_page']['data'] == 'bp_before_account_details_fields') ? 'checked' : ''; ?>>
								<?php echo __('BuddyPress account details fields ', 'wp-social')?>
							</label>
							

							<label class="xs_label_wp_login" for="buddypress_page_data__bp_after_register_page">
								<input class="wslu-global-radio-input" type="radio" id="buddypress_page_data__bp_after_register_page" name="xs_global[buddypress_page][data]" value="bp_after_register_page" <?php echo (isset($return_data['buddypress_page']['data']) && $return_data['buddypress_page']['data'] == 'bp_after_register_page') ? 'checked' : ''; ?>>
								<?php echo __('BuddyPress after register form ', 'wp-social')?>
							</label>
						</div>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						<button type="submit" name="global_setting_submit_form" class="xs-btn btn-special small"><?php echo esc_html__('Save Changes');?></button>
					</div>
				</div> <!-- ./ End Single Item -->
