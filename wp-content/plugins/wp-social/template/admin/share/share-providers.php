...
<div class="wslu-social-login-main-wrapper"> <?php 
	...
	<form action="<?php echo esc_url(admin_url().'admin.php?page=wslu_share_setting&tab=wslu_providers');?>" name="xs_provider_submit_form" method="post" id="xs_provider_form">
						...
						<div class="xs-block-footer">
							...
							<div class="right-content">
								<a 
									...
									<?php echo empty($enabled_providers[$k]['enable']) ? esc_html__('Getting Started', 'wp-social') : esc_html__('Settings', 'wp-social'); ?>
								</a>
							</div>
						</div>
					</div>
		...
		foreach($core_provider AS $k => $val):
			...
			<div class="xs-modal-dialog" id="example-modal-<?php echo $k;?>">
									...
									<div class="wslu-popup-data">
										...
										<div class="wslu-single-popup-item">
											<div class="setting-label-wraper">
												<label class="setting-label wslu-sec-title" for="<?php echo $k;?>_value">
													<?php echo __( 'Default '.$label.' Share Count' , 'wp-social');?> 
												</label>
											</div>

											<input name="xs_share[social][<?php echo $k;?>][data][value]" type="text" id="xs_<?php echo $k;?>_value" value="<?php echo esc_html($belowValue);?>" class="wslu-global-input">
										</div>

										<div class="wslu-single-popup-item">
											<div class="setting-label-wraper">
												<label class="setting-label wslu-sec-title" for="<?php echo $k;?>_text"><?php echo __( 'Text Below The Number' , 'wp-social');?> </label>
											</div>

											<input name="xs_share[social][<?php echo $k;?>][data][text]" type="text" id="xs_<?php echo $k;?>_text" value="<?php echo esc_html($belowText);?>" class="wslu-global-input">
										</div>

										<div class="wslu-single-popup-item">
											<div class="setting-label-wraper">
												<label class="setting-label wslu-sec-title" for="<?php echo $k;?>_label"><?php echo __( 'Label Name' , 'wp-social');?> </label>
											</div>

											<input name="xs_share[social][<?php echo $k;?>][data][label]" type="text" id="xs_<?php echo $k;?>_label" value="<?php echo esc_html($label);?>" class="wslu-global-input">
										</div>
