            ...
            <div class="xs-global-section">
                ...
                <div class="wslu-single-item">
                    ...
                    <div class="wslu-right-content wslu-inline">
                        ...
                        <label class="social_radio_button_label xs_label_wp_login">
                            <input class="social_radio_button wslu-global-radio-input" type="radio" name="xs_share[show_font_from_theme]" value="1" <?php echo (!empty($return_data['show_font_from_theme'])) ? 'checked' : ''; ?>>

				            <?php echo esc_html__('Yes', 'wp-social'); ?>
                        </label>

                        <label class="social_radio_button_label xs_label_wp_login">
                            <input class="social_radio_button wslu-global-radio-input" type="radio" name="xs_share[show_font_from_theme]" value="0" <?php echo (empty($return_data['show_font_from_theme'])) ? 'checked' : ''; ?>>

				            <?php echo esc_html__('No', 'wp-social'); ?>
						</label>
						
						<div class="wslu-help-text">
							<p><?php _e('Choose "Yes" if you want to use the default font family of the theme installed on your website.', 'wp-social'); ?></p>
						</div>
                    </div>
                </div>
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						<button type="submit" name="share_global_setting_submit_form" class="xs-btn btn-special small"><?php echo esc_html__('Save Changes'); ?></button>
					</div>
				</div>
