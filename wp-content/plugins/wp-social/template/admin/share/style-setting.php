        ...
        <div class="xs-social-block-wraper">
            <div class="xs-global-section">
                ...
                <div class="wslu-single-item wslu-share-layout">
                    ...
                    <div class="wslu-right-content horizontial">
                        <label class="social_radio_button_label xs_label_wp_login">
                            <input class="social_radio_button wslu-layout-btn wslu-global-radio-input" type="radio" name="xs_style[layout]" value="horizontal">
                        ...
                        <div class="primary-content-setting">
                            ...
                            <div class="primary-content-setting__content">
                                ...
                                <label for="_login_button_style__both_content" class="social_radio_button_label xs_label_wp_login primary-content-setting__item">
                                    <input class="social_radio_button wslu-global-radio-input" type="radio" id="_login_button_style__both_content" name="xs_style[login_content]" value="both_content" <?php echo (isset($return_data['login_content']) && $return_data['login_content'] == 'both_content') ? 'checked' : ''; ?>>
                            ...
                            <?php foreach ($share_hover_effects as $key => $value) : ?>
                                <div class="wlsu-hover-effect__item">
                                    <input 
                                        ...
                                        <?php echo ($mainEffect == $key) ? 'checked' : ''; ?>/>
                    ...
                    foreach ($styleArr as $k => $v) : ?>
                        <div class="wslu-single-social-style-item <?php echo esc_attr( ( (!did_action('wslu_social_pro/plugin_loaded')) && ($v['package'] == 'pro') ) ? 'wslu-style-pro': 'wslu-style-free' ); ?>">
                            ...
                            <label  class="social_radio_button_label xs_label_wp_login">
                                ...
                                <input class="social_radio_button  wslu-global-radio-input share-input-name" type="radio" id="_login_button_style__<?= $k; ?>" name="xs_style[login_button_style][main]" value="<?= $k; ?>" <?php echo esc_attr( ( (!did_action('wslu_social_pro/plugin_loaded')) && ($v['package'] == 'pro') ) ? 'disabled="disabled"': '' ); ?>>
                                <?php 
